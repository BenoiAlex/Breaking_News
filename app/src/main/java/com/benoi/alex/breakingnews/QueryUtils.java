...
class QueryUtils {
    ...
    static List<BreakingNews> fetchNewsData(String queryUrl, Context context) {
    ...
    private static List<BreakingNews> extractNews(String jsonResponse, Context context) {
                ...
                if (responseJSONObject.has(context.getString(R.string.results_array))) {
                    ...
                    for (int i = 0; i < resultsJSONArray.length(); i++) {
                        ...
                        if (currentJSONObject.has(context.getString(R.string.web_url))) {
                            url = currentJSONObject.getString(context.getString(R.string.web_url));
                        } else {
                            url = null;
                        }
                        ...
                        news.add(new BreakingNews(title, section, publicationDateTime, url, authors));
                    }
                }
            }
